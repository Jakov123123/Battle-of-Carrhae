...
namespace OTTER
{
    ...
    public class Sprite
    {
        ...
        //svojstva za sve jedinice
        public int JedinstveniBroj;
        protected int Nsnagakonjistrijelci;
        protected int Nsnagakonji;
        protected int Nsnagalegionari;
        protected int Osnagakonjistrijelci;
        protected int Osnagakonji;
        protected int Osnagalegionari;
        protected int Ljudstvo;
        ...
        public void Borba(Sprite napadnuti)
        {
            if (JedinstveniBroj < 8 || (JedinstveniBroj >= 12 && JedinstveniBroj < 15))
            {
                if (napadnuti.JedinstveniBroj < 8 || (napadnuti.JedinstveniBroj >= 12 && napadnuti.JedinstveniBroj < 15))
                {
                    RacunajBorba(napadnuti, Nsnagalegionari, napadnuti.Osnagalegionari);
                }
                else if ((napadnuti.JedinstveniBroj >= 8 && napadnuti.JedinstveniBroj < 10) || (napadnuti.JedinstveniBroj >= 15 && napadnuti.JedinstveniBroj < 18))
                {
                    RacunajBorba(napadnuti, Nsnagakonji, napadnuti.Osnagalegionari);
                }
                else if ((napadnuti.JedinstveniBroj >= 10 && napadnuti.JedinstveniBroj < 12) || (napadnuti.JedinstveniBroj >= 18 && napadnuti.JedinstveniBroj < 24))
                {
                    RacunajBorba(napadnuti, Nsnagakonjistrijelci, napadnuti.Osnagalegionari);
                }
            }
            else if ((JedinstveniBroj >= 8 && JedinstveniBroj < 10) || (JedinstveniBroj >= 15 && JedinstveniBroj < 18))
            {
                if (napadnuti.JedinstveniBroj < 8 || (napadnuti.JedinstveniBroj >= 12 && napadnuti.JedinstveniBroj < 15))
                {
                    RacunajBorba(napadnuti, Nsnagalegionari, napadnuti.Osnagakonji);
                }
                else if ((napadnuti.JedinstveniBroj >= 8 && napadnuti.JedinstveniBroj < 10) || (napadnuti.JedinstveniBroj >= 15 && napadnuti.JedinstveniBroj < 18))
                {
                    RacunajBorba(napadnuti, Nsnagakonji, napadnuti.Osnagakonji);
                }
                else if ((napadnuti.JedinstveniBroj >= 10 && napadnuti.JedinstveniBroj < 12) || (napadnuti.JedinstveniBroj >= 18 && napadnuti.JedinstveniBroj < 24))
                {
                    RacunajBorba(napadnuti, Nsnagakonjistrijelci, napadnuti.Osnagakonji);
                }
            }
            else if ((JedinstveniBroj >= 10 && JedinstveniBroj < 12) || (JedinstveniBroj >= 18 && JedinstveniBroj < 24))
            {
                if (napadnuti.JedinstveniBroj < 8 || (napadnuti.JedinstveniBroj >= 12 && napadnuti.JedinstveniBroj < 15))
                {
                    RacunajBorba(napadnuti, Nsnagalegionari, napadnuti.Osnagakonjistrijelci);
                }
                else if ((napadnuti.JedinstveniBroj >= 8 && napadnuti.JedinstveniBroj < 10) || (napadnuti.JedinstveniBroj >= 15 && napadnuti.JedinstveniBroj < 18))
                {
                    RacunajBorba(napadnuti, Nsnagakonji, napadnuti.Osnagakonjistrijelci);
                }
                else if ((napadnuti.JedinstveniBroj >= 10 && napadnuti.JedinstveniBroj < 12) || (napadnuti.JedinstveniBroj >= 18 && napadnuti.JedinstveniBroj < 24))
                {
                    RacunajBorba(napadnuti, Nsnagakonjistrijelci, napadnuti.Osnagakonjistrijelci);
                }
            }
            if (Ljudstvo <= 0 || Moral <= 0)
            {
                Ljudstvo = 0;
                Moral = 0;
            }
            if (napadnuti.Ljudstvo <= 0 || napadnuti.Moral <= 0)
            {
                napadnuti.Ljudstvo = 0;
                napadnuti.Moral = 0;
            }
        }

        private void RacunajBorba(Sprite napadnuti, int napad, int obrana)
        {
            Random g = new Random();
            int a = g.Next(1, 5);
            int b = g.Next(1, 5);
            int q = napadnuti.Ljudstvo;
            int r = Ljudstvo;
            napadnuti.Ljudstvo = napadnuti.Ljudstvo - b * napad;
            napadnuti.Moral = Math.Round(napadnuti.Moral - Math.Round(Convert.ToDouble((q - napadnuti.Ljudstvo) / 12), 2), 2);
            Ljudstvo = Ljudstvo - a * obrana;
            Moral = Math.Round(Moral - Convert.ToDouble(r - Ljudstvo) / 12, 2);
        }

        public int GetLjudstvo()
        {
            return Ljudstvo;
        }
        ...
        public void PomicanjeDolje()
        {
            Wait(0.1);
            SetY(Y + 49);
        }
        
        public void PomicanjeGore()
        {
            Wait(0.1);
            SetY(Y - 49);
        }
        
        public void PomicanjeDesno()
        {
            Wait(0.1);
            SetX(X + 78);
        }
        
        public void PomicanjeLijevo()
        {
            Wait(0.1);
            SetX(X - 78);
        }
